...
import nxt.nextech.blocks.Forge;
import nxt.nextech.crafting.RecipesForge;

public class ForgeTE extends TileEntity implements ISidedInventory {
    ...
    private String ForgeTE;

    public void ForgeTE(String string){
        this.ForgeTE = string;
    }
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.ForgeTE : "Forge";
    }

    @Override
    public boolean hasCustomInventoryName() {
        return this.ForgeTE != null && this.ForgeTE.length() > 0;
    }
    ...
    public void readFromNBT(NBTTagCompound tagCompound) {
        ...
        if (tagCompound.hasKey("CustomName", 8)) {
            this.ForgeTE = tagCompound.getString("CustomName");
        }
    }
    ...
    public void writeToNBT(NBTTagCompound tagCompound) {
        ...
        if (this.hasCustomInventoryName()) {
            tagCompound.setString("Forge", this.ForgeTE);
        }
    }
    ...
    public void updateEntity() {
        ...
        if (flag != this.furnaceBurnTime > 0) {
            flag1 = true;
            Forge.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
        }
    ...
    public static int getItemBurnTime(ItemStack itemstack){
        if(itemstack == null){
            ...
            if(item instanceof ItemBlock && Block.getBlockFromItem(item) != Blocks.air){
                ...
                if(item == NexItems.CoalAnthracite){
                    return 2000;
                }
            ...
            if(item == NexItems.CoalAnthracite) return 2000;
